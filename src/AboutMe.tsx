  ...
  return (
    <div id="About_me">
      ...
      <div className="flex justify-center gap-24 md:max-xl:gap-24 mx-32 my-14">
        <div>
          <p className="text-2xl font-main pb-8 md:max-xl:text-lg w-96 text-emerald-950">
            Меня зовут Павел Витко, я изучаю и практикую Когнитивно-Поведенческую терапию (КПТ).
          </p>
          <section className="grid grid-cols-2 gap-4 grid-rows-2 min-w-96 max-w-[30vw]">
            <article>
              <h2 className="text-xl xl:text-3xl font-main text-green-900">1.Образование</h2>
              <p className="font-secondary">Российский Государственный Социальный Университет 2021-2025гг.</p>
            </article>
            <article>
              <h2 className="text-xl xl:text-3xl font-main text-green-900">2.Опыт работы</h2>
            ...
            <article className="col-start-1 col-end-3 justify-self-center">
              <h2 className="text-xl xl:text-3xl font-main text-green-900">3.Этапы работы</h2>
